            ...
            switch (field.attr("type")) {
                ...
                case "select-one":
                    ...
                    if (!field.val()) {
                        var name = field.attr("name");
                        if (name == "ddlProvince") {
                            return options.allrules[rules[i]].alertTextSelectProvince;
                        } else if (name == "ddlSafe") {
                            return options.allrules[rules[i]].alertTextSelectQuestion;
                        } else {
                            return options.allrules[rules[i]].alertText;
                        }
                    }
        ...
        _calculatePosition: function(field, promptElmt, options) {
            ...
            switch (options.promptPosition) {
                ...
                case "topLeft":
                    ...
                    break;
                case "centerRight":
                    promptleftPosition += fieldWidth + 33;
                    break;
                case "bottomLeft":
                    promptTopPosition = promptTopPosition + field.height() - 6;
